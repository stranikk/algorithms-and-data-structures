...
class Exam(object):
    """docstring for Exam"""
    def __init__(self, theory,practise,if_bilet,result,exam_size,delta):
        self.theory = theory
    ...
    def calc_mediana(self):
        mediana1 = int(round(len(self.theory)/2))
        mediana2 = int(round(len(self.practise)/2))
        sum_mediana = self.theory[mediana1] + self.practise[mediana2]

        self.if_bilet.append(int(round(sum_mediana - (((self.delta)/100) * sum_mediana))))
        self.if_bilet.append(int(round(sum_mediana + (((self.delta)/100) * sum_mediana))))
